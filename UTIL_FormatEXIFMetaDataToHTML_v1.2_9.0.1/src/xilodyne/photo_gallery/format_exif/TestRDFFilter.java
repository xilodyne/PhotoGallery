package xilodyne.photo_gallery.format_exif;
...
//$Id: TestRDFFilter.java,v 1.1 2001-05-04 01:45:21 bwm Exp $
...
public class TestRDFFilter extends DefaultHandler implements RDFHandler
{
	...
	throws Exception
 {
	...
	if (args.length != 1) {
	    System.err.println("Usage: java xilodyne.photo_gallery.format_exif.TestRDFFilter <file-or-URL>");
	    System.exit(2);
	}
  ...
  */
 public void XliteralStatement (int subjectType, String subject,
			 ...
			 String lang)
{
  ...
  */
	 public void resourceStatement (int subjectType, String subject,
			  String predicate, String object)
{}
	 public void XresourceStatement (int subjectType, String subject,
		  String predicate, String object)
{
	System.out.println("{" +
			   predicate +
